...
cron_env="BACKEND_URL=${MONITOR_BACKEND_URL} RUN_STRIPE_CHECK=${RUN_STRIPE_CHECK} ALERT_EMAIL_TO=${ALERT_EMAIL_TO} SLACK_WEBHOOK_URL=${SLACK_WEBHOOK_URL} NTFY_TOPIC=${NTFY_TOPIC}"
